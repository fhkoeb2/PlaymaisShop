...
function CartPage() {
    _s();
    const { items, removeItem, updateQuantity, totalPrice } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    if (items.length === 0) {
